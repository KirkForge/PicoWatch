...
**Version:** 0.4.0 | **Last Updated:** 2026-05-29 | **Git:** `main`
...
| L6 OutputGuard | ✅ | Schema validation, PII detection/redaction, 32 rules, feedback loop |
...
```
147 tests PASSED in 70.29s
- test_types: 10/10 ✅
- test_config: 2/2 ✅
- test_cli: 2/2 ✅
- test_prompt_guard: 45/45 ✅
- test_output_guard: 17/17 ✅
- test_telemetry: 6/6 ✅
